...
<html lang="en">
  ...
  <head>
    ...
    <title>AbidjanSports Admin</title>
    
    <!-- DNS Prefetch pour accélérer le chargement des CDN -->
    ...
    <div class="app-wrapper">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">{{ Auth::user()->prenoms }} {{ Auth::user()->nom }}</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    {{ Auth::user()->prenoms }} {{ Auth::user()->nom }} - {{ ucfirst(Auth::user()->role) }}
          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ route('flash-informations.index') }}" class="nav-link">
                      <i class="nav-icon bi bi-list"></i>
                      <p>Liste des Flash informations</p>
                    </a>
                  </li>
                </ul>
              </li>
      ...
      <footer class="app-footer">
        ...
        <strong>
          ...
          <a href="https://obaxion.com" class="text-decoration-none">Obaxion</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
